...
public class Book implements Parcelable {
    ...
    public Book(String id, String title, String subTitle, String[] authors, String publisher,String publishedDate,String description,String thumbnail,int rating)
    {
       this.id=id;
       this.title=title;
